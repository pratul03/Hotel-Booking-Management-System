			...
			<div className="container mt-5 d-flex flex-column justify-content-center align-items-center">
				...
				{isLoading ? (
					<div className="d-flex align-content-center justify-content-center">
						<HashLoader color="#f4461b" loading={isLoading} size={120} speedMultiplier={1} cssOverride={{}} />
					</div>
				) : error ? (
					<div className="text-danger fw-semibold fs-4">Error: No Ticket Found</div>
